    ...
    children=[
        ...
        html.Div(
            ...
            children=[
                ...
                html.A(
                    href="/",  # Or provide any link/URL where the exit action happens
                    className="exit-btn",
                    children=html.Img(
                        src="/assets/exit.svg",  # Path to the SVG file in the assets folder
                        alt="Exit Icon",  # Alternative text for accessibility
                        className="exit-icon",  # Custom CSS class
                    ),
                ),
            ],
        ),

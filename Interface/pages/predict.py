...
layout = html.Div(
    ...
    children=[
        ...
        html.Div(
            ...
            children=[
                # Left: Home button
                html.A("TCO Classifier", href="/", className="home-btn"),

                # Middle: Language toggle
                html.Div(
                    style={"display": "flex", "alignItems": "center", "gap": "10px"},
                    children=[
                        dbc.Button("🇺🇸 English", href="/predict", color="primary", className="mx-1"),
                        dbc.Button("🇨🇳 中文", href="/predict-zh", color="light", className="mx-1"),
                    ],
                ),
    ...
    dcc.Store(id="raw-wavelength-en"),
    dcc.Store(id="raw-absorbance-en"),
    dcc.Store(id="raw-transmission-en"),
    dcc.Store(id="raw-optical_density-en"),
        ...
        html.Div(
            ...
            children=[
                ...
                dbc.InputGroup([
                    ...
                    dbc.Input(id="wavelength-en", type="number", min=300, max=800, step="any",
                ...
                dbc.InputGroup([
                    ...
                    dbc.Input(id="absorbance-en", type="number", min=0, max=1, step="any", 
                ...
                dbc.InputGroup([
                    ...
                    dbc.Input(id="transmission-en", type="number", min=0, max=100, step="any", 
                ...
                dbc.InputGroup([
                    ...
                    dbc.Input(id="optical_density-en", type="number", min=0, max=100000, step="any",
                              placeholder="Enter optical density"),
                    dbc.InputGroupText("0–100000"),
                ], className="mb-3"),

                # 🚀 Predict Button
                dbc.Button("🚀 Classify Material", id="predict-btn-en", color="primary", className="mt-3 w-100"),

                # Output
                html.Div(id="prediction-output-en", className="mt-3", style={"textAlign": "center"}),
            ]
        )
    ]
)
...
def register_callbacks(app):
    ...
    app.clientside_callback(
        ...
        """,
    [Output("raw-wavelength-en", "data"), Output("wavelength-en", "value")],
    [Input("wavelength-en", "value")]
    )
    ...
    app.clientside_callback(
        ...
        """,
    [Output("raw-absorbance-en", "data"), Output("absorbance-en", "value")],
    [Input("absorbance-en", "value")]
    )
    ...
    app.clientside_callback(
        ...
        """,
    [Output("raw-transmission-en", "data"), Output("transmission-en", "value")],
    [Input("transmission-en", "value")]
    )
    ...
    app.clientside_callback(
        ...
        """,
    [Output("raw-optical_density-en", "data"), Output("optical_density-en", "value")],
    [Input("optical_density-en", "value")]
    )
    ...
    # -------------------------
    @app.callback(
        Output("prediction-output-en", "children"),
        Input("predict-btn-en", "n_clicks"),
    State("wavelength-en", "value"),
    State("absorbance-en", "value"),
    State("transmission-en", "value"),
    State("optical_density-en", "value"),
    State("raw-wavelength-en", "data"),
    State("raw-absorbance-en", "data"),
    State("raw-transmission-en", "data"),
    State("raw-optical_density-en", "data"),
